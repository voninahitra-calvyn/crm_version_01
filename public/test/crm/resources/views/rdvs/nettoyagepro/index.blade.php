      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-white">
            <div class="box-header with-border rouge">
              <h3 class="box-title">Rendez-vous nettoyage pro</h3>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr class="header">
                    ...
                    <th class="">Mobile</th>
                    <th class="">Email</th>
                    <th class="">Surface total société</th>
                    <th class="">Surface de bureau</th>
                    <th class="">Sous contrat</th>
                    <th class="">Date anniversaire du contrat</th>
				...
				@foreach($rdvsnettoyagepro as $rdv)
					<tr>
