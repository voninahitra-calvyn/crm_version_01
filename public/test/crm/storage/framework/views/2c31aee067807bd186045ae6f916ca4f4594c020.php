...
<?php $__env->startSection('main-content'); ?>
						...
						<table id="tablestaff" class="table table-hover table-striped">
							...
							<?php $__currentLoopData = $staffs->sortByDesc('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
									...
									<td>
										<form  action = "<?php echo e(route('staffs.destroy', [$staff])); ?>" method="post" class="">
											<?php echo csrf_field(); ?>
	...
	<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/public/test/crm/resources/views/staffs/index.blade.php ENDPATH**/ ?>