...
<script>
	...
	var eventRdv2 = [
		<?php if(isset($dataevent3)): ?>
			<?php $__currentLoopData = $dataevent3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			/* {
				"summary" : "<?php echo $event3->title; ?>", 
				"location" : "<?php echo $event3->adresse_details; ?>", 
				"description" : "<?php echo $event3->note_details; ?>", 
				"start": {
					// "dateTime": "<?php echo $event3->start; ?>",
					"dateTime": "2020-06-12T19:00:00",
					"timeZone": "Europe/Paris"
				},
				"end": {
					// "dateTime": "<?php echo $event3->end; ?>",
...
<script>
  ...
  $(document).ready(function() {
	...
	<?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/public/test/crm/resources/views/layouts/partials/scripts.blade.php ENDPATH**/ ?>