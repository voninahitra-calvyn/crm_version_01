		...
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			...
			<?php echo csrf_field(); ?>
				...
				<div class="input-group">
					...
					<input type="text" name="email" id="email" value="<?php echo e(Auth::user()->email); ?>" hidden>
			...
			<div class="form-group">
				<div class="col-sm-12">
					<br/><a href="<?php echo e(url('/supports')); ?>" class="btn btn-default" target="_blank" >Retour</a>
				</div>
			</div>
	</section>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/public/test/crm/resources/views/supports/repondreticket.blade.php ENDPATH**/ ?>