					    ...
					    <div class="row center ">
							...
							<div class="col-md-4 exportpdfrdv">
								<form action="<?php echo e(route('rdvs.exportpdf', $rdv->id)); ?>" method="post" class="">
									...
									<button id="telechargerpdfficherdv2" type="submit" class="btn btn-danger pull-right"><i class="fa fa-file-pdf-o"></i> Télécharger</button>
								</form>
							</div>
							<div class="col-md-4">
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/public/test/crm/resources/views/rdvs/edit.blade.php ENDPATH**/ ?>