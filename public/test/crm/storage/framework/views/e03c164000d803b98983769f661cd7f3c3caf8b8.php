		...
		<div class="box box-danger">
            ...
            <form class="form-horizontal" method="post" action="<?php echo e(route('centreappels.updatecompte', [$compte])); ?>" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group <?php if($compte->statut <> 'Superviseur' || $compte->statut <> 'Agent'): ?> hidden <?php endif; ?>" id="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/public/test/crm/resources/views/centreappels/compte/edit.blade.php ENDPATH**/ ?>