            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="date_rendezvous" id="date_rendezvous" placeholder="dd-mm-yyyy" value=<?php echo e($rdv->date_rendezvous); ?>>
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" name="heure_rendezvous" id="heure_rendezvous" placeholder="Heure rendez-vous" value=<?php echo e($rdv->heure_rendezvous); ?>>
                            <div class="input-group-addon">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HeryADDAMS\KANDRA\Ohmycorp\app\Ohmycrm\resources\views/rdvs/edit.blade.php ENDPATH**/ ?>