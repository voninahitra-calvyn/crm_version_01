                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control selecttype" name="statut" id="statut" style="width: 100%;" <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> disabled <?php endif; ?>>
                            ...
                            <option id="rendezvousrefuse" value="Rendez-vous refusé" <?php echo e(( $rdv->statut == "Rendez-vous refusé") ? 'selected' : ''); ?>>Rendez-vous refusé</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HeryADDAMS\KANDRA\Ohmycorp\app\crm\resources\views/rdvs/edit.blade.php ENDPATH**/ ?>