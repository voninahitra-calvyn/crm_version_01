...
<header class="main-header">
 ...
 -->
			   ...
			   <?php if(Auth::guest()): ?>
                ...
                <?php else: ?>
					...
					<li <?php if(\Request::is('rendez-vous*','rdvs*')): ?> class="active" <?php endif; ?>>
						...
						<a href="<?php echo e(url('rendez-vous/tout')); ?>"><i class='fa fa-clock-o'></i> <span>Rendez-vous</span></a>
					</li>
					<?php endif; ?>
					<?php if(Auth::user()->statut <> 'Responsable' && Auth::user()->statut <> 'Commercial'): ?>
					<li <?php if(\Request::is('rendez-vous*','rdvs*')): ?> class="active" <?php endif; ?>>
  ...
  <?php /**PATH D:\HeryADDAMS\KANDRA\Ohmycorp\app\Ohmycrm\resources\views/layouts/partials/mainheader.blade.php ENDPATH**/ ?>