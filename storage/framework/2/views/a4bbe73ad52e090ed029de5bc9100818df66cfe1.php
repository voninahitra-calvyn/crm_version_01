			...
			<div  class="table-responsive box-body no-padding">
				<table id="tableajoutrdv" class="table table-hover table-striped">
					<thead class="theadexcel">
						<tr class="header">
					<th>Bouton choix du commercial</th>
				...
				<tr>
					<td>
						<form action = "<?php echo e(route('clients.rendezvous', [$cmpt])); ?>" method="post" class="">
							...
							<button class="btn btn-primary btn-xs" type="submit"><i class="fa fa-user"></i> Choisir client</button>
						</form>
					</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/resources/views/rdvs/ajoutrdv.blade.php ENDPATH**/ ?>