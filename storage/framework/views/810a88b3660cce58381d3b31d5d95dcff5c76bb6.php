            ...
            <form class="form-horizontal" method="post" action="<?php echo e(route('centreappels.store')); ?>">
				...
				<div class="box-body">
					<div class="form-group " id="">
						...
						<div class="col-sm-8">
							<input class="form-control col-sm-10" id="hidden_image" name="hidden_image" value="Aucun fichier sélectionné." disabled />
						</div>
						<div class="col-sm-2">
							<div class="btn btn-danger btn-file  audio">
								<input type="file" id="logo-centre" name="logoCallCenter" accept="image/*"/>Parcourir...
							</div>
						</div>
					</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\crm1\resources\views/centreappels/create.blade.php ENDPATH**/ ?>