...
<?php $__env->startSection('contentheader_levelactive'); ?>
	...
	<li><a href="<?php echo e(route('centreappels.compte', [$idcentreappel])); ?>">Compte</a></li>
	...
	<?php if(Auth::user()->statut == 'Administrateur' || Auth::user()->statut == 'Staff' || Auth::user()->statut == 'Superviseur'): ?>
		...
		<section class="content">
			<div class="box box-danger">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form class="form-horizontal" method="POST" action="<?php echo e(route('centreappels.storecompte', [$idcentreappel])); ?>" enctype="multipart/form-data">
				<input type="hidden" name="_method" value="GET">
					...
					<div class="box-body">
						...
						<div class="form-group <?php if(Auth::user()->statut <> 'Administrateur'  && Auth::user()->statut <> 'Superviseur'): ?> hidden <?php endif; ?>">
						...
						<div class="form-group <?php if(Auth::user()->statut <> 'Administrateur'  && Auth::user()->statut <> 'Superviseur'): ?> hidden <?php endif; ?>">
							...
							<div class="col-sm-10">
								<select class="form-control selecttype" name="statut" style="width: 100%;">
									<option selected="selected" class="<?php if(Auth::user()->statut <> 'Administrateur'): ?> hidden <?php endif; ?>">Superviseur</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/resources/views/centreappels/compte/create.blade.php ENDPATH**/ ?>