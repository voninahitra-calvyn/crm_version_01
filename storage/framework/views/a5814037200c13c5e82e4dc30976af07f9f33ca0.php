		...
		<div class="box-body table-responsive no-padding">
			<table id="tableclient" class="table table-hover table-striped">
				...
				<tr>
					...
					<td>
						<form  action = "<?php echo e(route('clients.destroy', $client->id)); ?>" method="post" class="" onsubmit="return confirmDelete();">
							<?php echo csrf_field(); ?>
					...
					<td><?php echo e($client->etat ? $client->etat : 'Actif'); ?></td>
				</tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\crm1\resources\views/clients/index.blade.php ENDPATH**/ ?>