		...
		<div class="box-body table-responsive no-padding">
			<table id="tableclientcompte" class="table table-hover table-striped">
				...
				<tr>
					...
					<td>
						<form  action = "<?php echo e(route('clients.suppcompte', [$compte])); ?>" method="post" class=""  onsubmit="return confirmDelete();">
							<?php echo csrf_field(); ?>
							<?php echo method_field('GET'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\crm1\resources\views/clients/compte/index.blade.php ENDPATH**/ ?>