      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse mobile-menu" id="navbar-collapse">
			...
			<ul class="nav navbar-nav">
                 <li <?php if(\Request::is('home*')): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/home')); ?>">ACCUEIL</a></li>
			   <?php if(Auth::guest()): ?>
  ...
  <?php /**PATH E:\projet freelance\crm1\resources\views/layouts/partials/mainheader.blade.php ENDPATH**/ ?>