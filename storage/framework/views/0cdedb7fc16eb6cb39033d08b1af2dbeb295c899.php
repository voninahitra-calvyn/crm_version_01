			...
			<div class="box-body table-responsive no-padding">
				<table id="tablecentreappel" class="table table-hover table-striped">
					...
					<tr>
						...
						<td>
							<form  action = "<?php echo e(route('centreappels.destroy', $centreappel->id)); ?>" method="post" class="" onsubmit="return confirmDelete();">
								<?php echo csrf_field(); ?>
						...
						<td><?php echo e($centreappel->etat ? $centreappel->etat: 'Actif'); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projet freelance\crm1\resources\views/centreappels/index.blade.php ENDPATH**/ ?>