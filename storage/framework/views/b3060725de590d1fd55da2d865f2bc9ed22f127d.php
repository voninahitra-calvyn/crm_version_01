		...
		<div class="row">
			...
			<div class="col-md-8">
						...
						<div class="box-body">
							...
							<div class="form-group" id="">
								...
								<div class="col-sm-10">
									...
									<input type="hidden" id="hidden_audio1" name="hidden_audio1" value="<?php echo e($staff->audio); ?>" />
				...
				<div class="box box-danger hidden">
					...
					<?php if(session()->get('successBackup')): ?>
						<div class="alert alert-success">
						  <?php echo e(session()->get('successBackup')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/452225fdd1f675c63558ad49feb51168/crm/resources/views/staffs/moncompte.blade.php ENDPATH**/ ?>