    ...
    <section class="content">
		<div class="box box-danger">
            <form class="form-horizontal" method="GET" action="<?php echo e(route('rdvs.storerdv')); ?>">
                ...
                <input type="hidden" name="oui_non_lu" value="non_lu">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projet freelance\crm1\resources\views/rdvs/create.blade.php ENDPATH**/ ?>