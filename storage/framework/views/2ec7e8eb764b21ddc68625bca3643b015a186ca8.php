    ...
    <div class="box box-danger">
        <form class="form-horizontal" method="post" action="<?php echo e(route('rdvs.update', $rdv->id)); ?>" enctype="multipart/form-data">
            ...
            <div class="box-body">
				...
				<input type="text" class="form-control hidden" value="<?php echo e($rdv->id_groupe); ?>" name="id_groupe" id="rdv_id_groupe">
				<input type="text" class="form-control hidden" value="<?php echo e($clientComResp->client_id); ?>" name="client_id" id="client_id_camp">
				<input type="text" class="form-control hidden" value="<?php echo e($clientComResp->email); ?>" name="client_emailpriv" id="client_emailpriv_camp">
				<input type="text" class="form-control hidden" value="<?php echo e($clientComResp->nom); ?>" name="client_nompriv" id="client_nompriv_camp">
				<input type="text" class="form-control hidden" value="<?php echo e($clientComResp->prenom); ?>" name="client_prenompriv" id="client_prenompriv_camp">
				...
				<div class="form-group">
						<label for="typerdv" class="col-sm-2 control-label">Client : </label>
						<div class="col-sm-10">
							<select class="form-control select2" name="cli" id="campagne-client" style="width: 100%;" <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> disabled <?php endif; ?>>
									<option value="<?php echo e($rdv->cli); ?>" selected
											data-campagne-client-nom="<?php echo e($clientComResp->nom); ?>"
											data-campagne-client-id="<?php echo e($clientComResp->client_id); ?>"
											data-campagne-client-prenom="<?php echo e($clientComResp->prenom); ?>"
											data-campagne-client-email="<?php echo e($clientComResp->email); ?>"
									><?php echo e($rdv->cli); ?></option>
								<?php $__currentLoopData = $clientCom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client_commercial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($client_commercial->nom); ?> (<?php echo e($client_commercial->societe2); ?>)"
											data-campagne-client-nom="<?php echo e($client_commercial->nom); ?>"
											data-campagne-client-id="<?php echo e($client_commercial->client_id); ?>"
											data-campagne-client-prenom="<?php echo e($client_commercial->prenom); ?>"
											data-campagne-client-email="<?php echo e($client_commercial->email); ?>">
										<?php echo e($client_commercial->nom); ?> (<?php echo e($client_commercial->societe2); ?>)</option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" name="typerdv" id="typerdv" style="width: 100%;" <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> disabled <?php endif; ?>>
				...
				<div class="form-group"  id="groupcentreappel">
						...
						<div class="col-sm-10">
							<select class="form-control select2" name="centreappel_societe" id="centreappel_societe_ch" style="width: 100%;" <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> disabled <?php endif; ?>>
								<option value="Groupe Administration" <?php echo e($rdv->centreappel_societe =="Groupe Administration" ? 'selected' : ''); ?> data-centre="<?php echo e($rdv->id_groupe); ?>">
									Groupe Administration </option>
								<?php $__currentLoopData = $centreAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $centre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($centre->societe); ?>" <?php echo e($centre->societe==$rdv->centreappel_societe ? 'selected' : ''); ?> data-centre="<?php echo e($centre->_id); ?>"><?php echo e($centre->societe); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
				</div>
				...
				<div class="form-group"  id="groupresponsableagent">
						...
						<div class="col-sm-10">
							<select class="form-control select2" name="responsableagent" id="centreappel_societe_agent" style="width: 100%;" <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> disabled <?php endif; ?>>
								<option value="<?php echo e($rdv->user_id); ?>,<?php echo e($rdv->user_prenom); ?> <?php echo e($rdv->user_nom); ?>"  selected><?php echo e($rdv->user_prenom); ?> <?php echo e($rdv->user_nom); ?></option>
							</select>
						</div>
				</div>
				...
				<?php if(Auth::user()->statut != 'Responsable' || Auth::user()->statut != 'Commercial'): ?>
							...
							<div class="form-group"  id="created_at">
								<label for="nom" class="col-sm-2 control-label">Date de création : </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="#" id="#" placeholder="Date de création" value="<?php echo e($rdv->created_at->format('j-m-Y H:i')); ?>" disabled>
								</div>
							</div>
				<?php endif; ?>			
			...
			<?php if(Auth::user()->statut != 'Responsable' || Auth::user()->statut != 'Commercial'): ?>	
				<div class="form-group" id="updated_at">
								<label for="nom" class="col-sm-2 control-label">Date de modification : </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="#" id="#" placeholder="Date de modification" value="<?php echo e($rdv->updated_at->format('j-m-Y H:i')); ?>" disabled>
								</div>
				</div>
			<?php endif; ?>	
			<div class="form-group <?php if(Auth::user()->statut <> 'Administrateur' && Auth::user()->statut <> 'Staff'): ?> hidden <?php endif; ?>" id="ismailEnvoi" >
				<label for="ismailEnvoi" class="col-sm-2 control-label"> </label>
				<div class="col-sm-10 form-check">
				<input type="checkbox" class="form-check-input" name="ismailEnvoi" id="materialChecked" checked="">
				<label class="form-check-label" for="materialChecked">Envoyé l'email?</label>
				</div>
             </div>
        ...
        <form class="form-horizontal" method="post" action="<?php echo e(route('rdvs.update', $rdv->id)); ?>" enctype="multipart/form-data">
            <input type="hidden" name="_method" value="PUT">
					    ...
					    <div class="row center ">
							...
							<div style="margin-top: -60px;text-align: center;" class="col-md-4 exportpdfrdv">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\crm1\resources\views/rdvs/edit.blade.php ENDPATH**/ ?>