    ...
    <section class="content">
		<div class="box box-danger">
            <form class="form-horizontal" method="GET" action="{{ route('rdvs.storerdv') }}">
                ...
                {!! csrf_field() !!}
				<div class="box-body">
					<input type="text" class="form-control hidden" value="{{$compte->nom}}" name="client_nompriv" id="client_nompriv">
					<input type="text" class="form-control hidden" value="{{$compte->prenom}}" name="client_prenompriv" id="client_prenompriv">
					...
					<input type="text" class="form-control hidden" value="{{Auth::user()->_id}}" name="user_id" id="user_id">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control selecttype" name="cli" id="cli" style="width: 100%;">
								<option selected="selected">{{$compte->nom}} ({{$client->societe2}})</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group" id="groupcentreappel">
						...
						<div class="col-sm-10">
							<!-- <input type="text" class="form-control" value="{{$client->societe}}" name="client_societe" id="client_societe"> -->
							<input type="text" class="form-control @if (Auth::user()->statut <> 'Superviseur' && Auth::user()->statut <> 'Agent') hidden @endif" value="{{$nomsocieteCentreappels}}" disabled>
					...
					<div class="form-group" id="groupresponsableagent">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control @if (Auth::user()->statut <> 'Superviseur' && Auth::user()->statut <> 'Agent') hidden @endif" value="{{Auth::user()->prenom}} {{Auth::user()->nom}}" disabled>
							<input type="text" class="form-control @if (Auth::user()->statut == 'Superviseur' || Auth::user()->statut == 'Agent') hidden @endif" value="{{Auth::user()->prenom}} {{Auth::user()->nom}}" name="responsableagent" id="responsableagent">
						</div>
					</div>
				...
				<div id="groupnomprenomcontact">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="nomprenomcontact" id="nomprenomcontact" placeholder="Nom et prénom du contact" >
						</div>
					</div>
				</div>
                <div id="groupautre2">
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<div class="input-group">
								...
								<!-- <input type="text" class="form-control @if (Auth::user()->statut <> 'Superviseur' && Auth::user()->statut <> 'Agent') hidden @endif" disabled> -->
								<!-- <input type="text" class="form-control @if (Auth::user()->statut == 'Superviseur' || Auth::user()->statut == 'Agent') hidden @endif" name="date_rendezvous" id="date_rendezvous" placeholder="dd-mm-yyyy" > -->
								<div class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</div>
							</div>
                ...
                <div class="form-group" id="groupautre3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control @if (Auth::user()->statut <> 'Superviseur' && Auth::user()->statut <> 'Agent') hidden @endif" rows="3" placeholder="Note du Staff" disabled> </textarea>
                        <textarea class="form-control @if (Auth::user()->statut == 'Superviseur' || Auth::user()->statut == 'Agent') hidden @endif" rows="3" name="notestaff" id="notestaff" placeholder="Note du Staff"> </textarea>
                    </div>
                </div>
